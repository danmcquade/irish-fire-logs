...
<head>
    ...
    <link rel="canonical" href="http://irishfirelogs.com/mailinglist-final.php" />
    <meta charset="utf-8">
        ...
        <!-- Three columns of text below the carousel -->
         <div class="row featurette">
            <div class="col-lg-8 about">
                <h1>Success!</h1>
                <p class="lead home">Thank you! Your subscription to the Irish Fire Logs Mailing List has been successfully confirmed.</p>
            </div>
            <div class="col-md-3">
                	<center>
