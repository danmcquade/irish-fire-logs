...
<head>
    ...
    <title>Contact Us - Siobhán's Irish Fire Logs</title>
...
<div class="marketing about peat"><div class="pagestarter"><h1>Contact Us</h1></div></div>
<p>
    <h4 class="ContactInfo">
    The Ballydesmond Company</h4>
    1730 Rhode Island Ave NW #800<br>
    Washington, DC 20036<br>
    <!-- <a href="mailto: @ballydesmondco.com">@ballydesmondco.com</a> -->
    <h5 style="margin: 0px 0px 0px 0px;">+1 (800) 707-6175</h5>
</p>
<p>
    <h4 class="ContactInfo" style="font-size: 12pt;">
    Irish Fire Logs - Warehouse</h4>
    8952 Brookville Road<br>
    Silver Spring, MD 20910<br>
</p>

<form method="POST" action="contact-submit.php" class="form-horizontal" id="IFcontact">
<fieldset>
